...
public class AdministratorSystemConfigurationUpdateService implements AbstractUpdateService<Administrator, SystemConfiguration>{
	...
	public void bind(final Request<SystemConfiguration> request, final SystemConfiguration entity, final Errors errors) {
		...
		request.bind(entity, errors, "currency", "currencies", "language","weakTermsSpanish","weakTermsEnglish", "strongTermsEnglish","strongTermsSpanish","weakThreshold","strongThreshold");
	...
	public void unbind(final Request<SystemConfiguration> request, final SystemConfiguration entity, final Model model) {
		...
		request.unbind(entity, model, "currency", "currencies", "language","weakTermsSpanish","weakTermsEnglish", "strongTermsEnglish","strongTermsSpanish","weakThreshold","strongThreshold");
