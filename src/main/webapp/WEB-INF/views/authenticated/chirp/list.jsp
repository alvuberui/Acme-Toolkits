...
<acme:list readonly="true">
	...
	<acme:list-column code="authenticated.chirp.list.label.body" path="body" width="40%"/>
	<acme:list-column code="authenticated.chirp.list.label.email" path="email" width="20%"/>	
</acme:list>