...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		<acme:menu-option code="master.menu.anonymous" access="isAnonymous()">
			...
			<acme:menu-suboption code="master.menu.anonymous.chirps.list" action="/anonymous/chirp/list"/>
			<acme:menu-separator/>
		...
		<acme:menu-option code="master.menu.administrator" access="hasRole('Administrator')">
			...
			<acme:menu-suboption code="master.menu.administrator.chirps.list" action="/administrator/chirp/list"/>
			<acme:menu-separator/>
		...
		<acme:menu-option code="master.menu.inventor" access="hasRole('Inventor')">
			...
			<acme:menu-suboption code="master.menu.inventor.chirps.list" action="/inventor/chirp/list"/>
		</acme:menu-option>
		
		<acme:menu-option code="master.menu.patron" access="hasRole('Patron')">
			<acme:menu-suboption code="master.menu.patron.components.list" action="/patron/artefact/list-all-components"/>
			<acme:menu-suboption code="master.menu.patron.chirps.list" action="/patron/chirp/list"/>
		</acme:menu-option>
	...
	<acme:menu-right>
		...
		<acme:menu-option code="master.menu.user-account" access="isAuthenticated()">
			...
			<acme:menu-suboption code="master.menu.user-account.chirps.list" action="/authenticated/chirp/list"/>
